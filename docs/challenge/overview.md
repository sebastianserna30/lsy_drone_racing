...
|---|---|---|---|---|
| [Level 0](https://github.com/learnsyslab/lsy_drone_racing/blob/main/config/level0.toml) | No | No | No | Perfect knowledge |
| [Level 1](https://github.com/learnsyslab/lsy_drone_racing/blob/main/config/level1.toml) | Yes | No | No | Adaptive |
| [Level 2](https://github.com/learnsyslab/lsy_drone_racing/blob/main/config/level2.toml) | Yes | Yes | No | Learning, re-planning |
| [Level 3](https://github.com/learnsyslab/lsy_drone_racing/blob/main/config/level3.toml) | Yes | Yes | Yes | Online planning |
| sim2real | Real hardware | Yes | Yes | Sim2real transfer |

<!--
| Bonus ([config/multi_level3.toml](https://github.com/learnsyslab/lsy_drone_racing/blob/main/config/multi_level3.toml)) | Yes | Yes | | | Multi-agent racing |
-->
