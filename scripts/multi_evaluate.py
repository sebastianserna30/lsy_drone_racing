...
def main():
    ...
    ep_times = simulate(config=config_file, controllers=controllers, n_runs=n_runs, render=False)
    ...
    percent_overtake = 100.0 * overtakes / both_finished if both_finished > 0 else 0.0
